...
class AppDefImage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppDefImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppDefImage:
        """Create an instance of AppDefImage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppDefImage.parse_obj(obj)

        _obj = AppDefImage.parse_obj({
            "data": obj.get("data"),
            "type": obj.get("type")
        })
        return _obj
