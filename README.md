...
```sh
pip install git+https://github.com/nimbix/python-jarviceapi
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/nimbix/python-jarviceapi`)
